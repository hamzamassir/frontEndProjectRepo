  ...
  return ( 
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className=' max-h-[500px] relative'>
            ...
            <img className='rounded-xl w-full max-h-[300px] object-cover' src="https://images.pexels.com/photos/1639562/pexels-photo-1639562.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="/" />
        </div>
    </div>
  )
}
